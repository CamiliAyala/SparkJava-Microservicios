...
public class Path {
    ...
    public static class Web {
        ...
        @Getter public static final String PROCESAR = "/api/procesarLogin";
        @Getter public static final String INICIO = "/api/inicio";
        @Getter public static final String INFORESTAURANTE = "/api/restaurante/misDatos";
        @Getter public static final String PLATOSRESTAURANTE = "/api/restaurante/platos";
        @Getter public static final String INFOPEDIDOS = "/api/restaurante/pedidos";
